...
- yxip.nmmd.cc.cd/all  |  所有收集的 CF 优选域名
- yxip.nmmd.cc.cd/v6  |  仅包含支持 v6 的域名，部分官方优选 ipv6
- 正在建设：自动优选 ipv4/6 地址、适配校园网免流优选 ip...

均为 txt 格式，域名或 IP 每行一个，ipv6 地址用英文方括号包裹。所有优选 IP 均支持 6 个 443 系端口：`443`, `2053`, `2083`, `2087`, `2096`, `8443`
